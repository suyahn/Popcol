...
<script type="text/javascript">
	$(function() {
		...
		$('#view').load('mypage_Modifyintro.do');
	});
</script>
</head>
<body>
			...
			<div class="col-sm-3 col-sm-pull-9">
				<div class="text-xs-center text-sm-left">			
					<ul class="nav nav-stacked menu">
						...
						<li class="mypage" id="mypage_Modifyintro_li"><a href="#" class="mypage" id="mypage_Modifyintro">회원 정보 수정</a></li>
						<li class="mypage" id="mypage_byePopcolForm_li"><a href="#" class="mypage" id="mypage_byePopcolForm">회원 탈퇴</a></li>
