...
<body>
	<div class="container" align="center" style="width: 70%">
		<h1 align="left" style="font-weight: bold;"><a href='adminQnaList.do' class="red-active">1:1 문의</a></h1>
		<hr>
		...
		<div align="right">
			<button type="button" class="btn btn-primary" onclick="location.href='adminQnaInsertForm.do?pageNum=${ pageNum }'"
				...
				<nav aria-label="Page navigation">
					<ul class="pagination">
						<c:if test="${ pp.startPage > pp.PAGE_PER_BLOCK }">
							<li>
								<a href="adminQnaList.do?pageNum=${ pp.startPage - 1 }" aria-label="Previous">
						...
						<c:forEach var="i" begin="${ pp.startPage }" end="${ pp.endPage }">
							<li <c:if test="${ pp.currentPage == i }">class="active"</c:if>><a href="adminQnaList.do?pageNum=${ i }">${ i }</a>
						</c:forEach>
						
						<c:if test="${ pp.endPage < pp.totPage }">
							<li>
								<a href="adminQnaList.do?pageNum=${ pp.startPage + pp.PAGE_PER_BLOCK }" aria-label="Next">
